...
const productosBase = [
  ...
  { id: "b6", nombre: "Chocolate Caliente", precio: 1500, categoria: "Bebidas", disponible: true, imagen: "/chocolate.jpg", config: {leche: ["Con Leche", "Sin Leche"], azúcar: ["Con Azúcar", "Sin Azúcar"]},
